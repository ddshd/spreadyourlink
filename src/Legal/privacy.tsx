import {ADDITIONAL_SERVICES, CONTACT_EMAIL, WEBSITE_NAME, WEBSITE_URL} from "../other/variables";
...
export default function PrivacyPolicy() {
    return (
        <div className="AccordionDetails-text">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Device</strong> means any device that can access the Service such as a computer, a
                        cellphone, an electric vehicle, or a digital tablet.</p>
                </li>
                <li>
                    <p><strong>Personal Data</strong> is any information that relates to an individual.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to {WEBSITE_NAME}, accessible from <a className="link-changed"
                                                                                             href={WEBSITE_URL()}
            ...
            <ul>
                <li>Usage Data</li>
                <li>Any data you share to the Service</li>
            </ul>
            <h3>Usage Data</h3>
            ...
            <h3>Other Data</h3>
            <p>Additional Data is collected automatically when using the Service for it's intended purpose.</p>
            <p>This additional data includes information, including, but not limited to, when you last used the Service,
                the link(s) you share to the Service to take advantage of it's intended functionality.</p>
            <p>You agree to not submit any information to our Service, through any method, that you do not want
            ...
            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
                ...
                close Your web browser. You can learn more about cookies on <a className="link-changed"
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as
                        remembering your secret code. The purpose of these Cookies is to provide You with a more
                        personal experience and to avoid You having to re-enter your secret code every time You use the
                        Website.</p>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <p><strong>For other purposes</strong>: We may use Your information for other purposes, such as data
                        analysis, identifying usage trends, and to evaluate and improve our Service, products, services,
            ...
            <ul>
                ...
                <li><strong>With other users:</strong> when You share personal information or otherwise interact in the
                    ...
                    distributed outside, including, but not limited to, if another user accesses the service using your
                    secret code obtained through any method.
                </li>
            ...
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do
                ...
                Remember: ANYONE the access the link you shared with your Service for easy access with just access to
                your secret code.</p>
            ...
            <p>Our Service will contain links to other websites that are not operated by Us. If You click on a third
            ...
            <p>We use third-party tools and services to operator and track the usage of this Service. By using this
                service you also agree to their respective Privacy Policies. Some of these tools and services include,
                but not limited to, {ADDITIONAL_SERVICES}.</p>
